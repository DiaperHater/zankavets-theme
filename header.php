...
<body>
  ...
  <!-- Header -->
  <header class="fixed top-0 left-0 z-50 w-full text-white bg-neutral-900 group/header">
    <div class="wrapper">
      <div class="box">
        <!-- Inner -->
        <nav class="py-6 flex items-center duration-200 group-[.narrow]/header:py-3">
          <!-- Logo -->
          <a href="<?= home_url() ?>" class="mr-12 text-2xl font-bold leading-none text-yellow-300 uppercase duration-200 hover:text-yellow-500">
            Zankavets
          </a>
          <!-- ArrowDecor -->
          ...
          <div class="flex items-center ml-auto gap-x-4 lg:ml-12">
            ...
            <!-- LangSwitch -->
            <!-- <a href="#" class="group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-yellow-300 duration-200 group-hover:text-yellow-500">
      ...
      <div class="wrapper">
        <div class="box">
          ...
          <div class="flex flex-col pb-40 gap-y-16 pt-14">
            ...
            <!-- Contact -->
            <a href="/contacts" class="self-center button">
              contact
            </a>
          </div>
        </div>
